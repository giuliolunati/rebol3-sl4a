 ...
 */
public class Rebol3Main extends Activity {
  ...
  protected synchronized void install() {
    ...
    Rebol3Installer installTask;
    try {
      installTask = getInterpreterInstaller(mDescriptor, Rebol3Main.this, mTaskListener);
  ...
  protected synchronized void uninstall() {
    ...
    try {
      uninstallTask = getInterpreterUninstaller(mDescriptor, Rebol3Main.this, mTaskListener);
    } catch (Sl4aException e) {
      Log.e(this, e.getMessage(), e);
      return;
    }
  ...
  protected Rebol3Installer getInterpreterInstaller(InterpreterDescriptor descriptor,
